...
//				.findCycles();
	 ...
	 * @throws IOException 
	 */
	void buildDependencyGraph(Graph outGraph, MemoizedFunction<Object, Node> objectToNode, Txn txn, String[] resourceKey, Predicate<? super Txn> isStale) throws IOException {
